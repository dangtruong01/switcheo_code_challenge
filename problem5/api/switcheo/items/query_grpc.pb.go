...
const (
	Query_Params_FullMethodName  = "/switcheo.items.Query/Params"
	Query_Item_FullMethodName    = "/switcheo.items.Query/Item"
	Query_ItemAll_FullMethodName = "/switcheo.items.Query/ItemAll"
)
