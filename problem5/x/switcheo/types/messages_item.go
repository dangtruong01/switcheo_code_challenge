...
func NewMsgCreateItem(creator string, name string, owner string) *MsgCreateItem {
...
func NewMsgUpdateItem(creator string, id uint64, name string, owner string) *MsgUpdateItem {
